...
?>
        ...
        <form class="form-edit-pessoa">
            <div class="modal-header">
                <h4 class="modal-title">
                    <span>Editar os dados da Pessoa</span>
                </h4>
            ...
            <div class="modal-body">
                ...
                <input type="hidden" name="idpessoa" id="idpessoa_edit" value="<?= $row->idpessoa; ?>">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6">
                        <div class="row form-group g-3 align-items-center">
                            ...
                            <div class="col-9">
                                ...
                                <select name="escola" id="escola_edit" class="selectpicker form-control" title="Selecione a escola" placeholder="Escola" required>
                                <?php
                                    $sql2 = $escola->readAll();
                        ...
                        <div class="row form-group g-3 align-items-center">
                            ...
                            <div class="col-9">
                                <input type="text" name="matricula" id="matricula_edit" value="<?= $row->matricula; ?>" minlength="5" maxlength="20" class="form-control col-6" title="Informe o n&uacute;mero da matr&iacute;cula escolar" placeholder="Matr&iacute;cula" required>
                            </div>
                        </div>
                        ...
                        <div class="row form-group g-3 align-items-center">
                            ...
                            <div class="col-9">
                                <input type="text" name="nome" id="nome_edit" value="<?= $row->nome; ?>" minlength="2" maxlength="200" class="form-control" title="Informe o nome do pessoa" placeholder="Nome" required>
                            </div>
                        </div>
            ...
            <div class="modal-footer d-flex">
                ...
                <div class="ml-auto">
                    ...
                    <button type="submit" class="btn btn-primary btn-edit-pessoa">Salvar</button>
                </div>
            </div>
        </form>
        ...
        <script>
            $(document).ready(function () {
                ...
                $('.form-edit-pessoa').submit(function (e) {
                    e.preventDefault();

                    $.post('pessoaUpdate', $(this).serialize(), function (data) {
                        $('.btn-edit-pessoa').html('<img src="dist/img/rings.svg" class="loader-svg">').fadeTo(fade, 1);

                        switch (data) {
                            case 'true':
                                Toast.fire({
                                    icon: 'success',
                                    title: 'Dados da pessoa editados.'
                                }).then((result) => {
                        ...
                        $('.btn-edit-pessoa').html('Salvar').fadeTo(fade, 1);
                    });
...
unset($cfg, $database, $db, $escola, $pessoa, $sql, $row, $sql2, $row2);